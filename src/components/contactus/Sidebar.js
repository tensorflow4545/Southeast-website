...
export default function Sidebar(){
    const [button , selectbutton]=useState(3);
    return(
        <>  
        ...
        <div className="flex">
            ...
            <div className="lg:w-max md:w-[200px] h-max rounded-[20px] bg-white lg:px-[60px] px-[10px] py-[10px] mt-[50px]">
               ...
               {/* routes */}
               <Link href={"#"} onClick={()=>{selectbutton(3)}}><div className="flex items-center justify-start gap-[25px] my-[20px] delay-100 duration-500 transition hover:scale-105">
